    ...
    return (
        ...
        <div className='row col-12 col-md-6 col-lg-5 shadow border border-1 p-3 m-4 '>
            ...
            <div className='col-12 col-lg-6'>
                ...
                <p>market cap usd: {Number(item.market_cap_usd).toFixed(2)}</p>

            </div>
            <div className='col-12 col-lg-6'>
                <p>available supply: {Number(item.available_supply).toFixed(2)}</p>
                <p>max supply: {Number(item.max_supply).toFixed(2)}</p>
                <p>percent change 1h: {Number(item.percent_change_1h).toFixed(2)}</p>
                <p>percent change 7d: {Number(item.percent_change_7d).toFixed(2)}</p>
